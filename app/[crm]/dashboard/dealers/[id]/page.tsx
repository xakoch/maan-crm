    ...
    return (
        <div className="container mx-auto py-10 space-y-8">
            <div className="flex items-center gap-4">
                <Link href={`/${crm}/dashboard/dealers`}>
            ...
            <div className="border rounded-lg overflow-hidden shadow-sm bg-card">
                <div className="p-6 border-b flex items-center justify-between bg-muted/30">
                    ...
                    <Link href={`/${crm}/dashboard/managers/create?tenant_id=${dealer.id}`}>
                                ...
                                managers.map((manager) => (
                                    <tr key={manager.id} className="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted">
                                        ...
                                        <td className="p-4 align-middle text-right">
                                            <Link href={`/${crm}/dashboard/managers/${manager.id}`}>
