...
export default async function ClientsPage({ params }: { params: Promise<{ crm: string }> }) {
    ...
    return (
        <div className="container mx-auto py-10">
            ...
            <ClientsClient data={clients} dealers={dealers} createLink={`/${crm}/dashboard/clients/create`} />
        </div>
    )
}
