...
export default async function DashboardPage({ params }: { params: Promise<{ crm: string }> }) {
    ...
    // For MAAN CRM, pass tenantId to filter stats
            ...
            <Tabs defaultValue="overview" className="space-y-4">
                <TabsList>
                    ...
                    <TabsTrigger value="analytics" asChild>
                        <Link href={`/${crm}/dashboard/analytics`}>Аналитика</Link>
                    </TabsTrigger>
