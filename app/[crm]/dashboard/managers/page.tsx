...
export default async function ManagersPage({ params }: { params: Promise<{ crm: string }> }) {
    ...
    return (
        <div className="container mx-auto py-10">
            ...
            <ManagersClient data={managers} dealers={dealers} createLink={`/${crm}/dashboard/managers/create`} />
        </div>
    )
}
